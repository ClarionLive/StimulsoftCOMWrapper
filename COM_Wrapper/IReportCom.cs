...
namespace Stimulsoft.Report.Com
{
    ...
    public interface IReportCom
    {
        ...
        void ConnectToDatabase(string dataset, string connectionString);

        void CreateFromScratch(string connectionString);

        void AssignVariable(string variableName, string value);

        void AddVariable(string variableName, string variableType, string value);
